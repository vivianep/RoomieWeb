...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
		...
		<spring:url value="/resources/vendors/bower_components/material-design-iconic-font/dist/css/material-design-iconic-font.min.cs" var="vendors_bower_material" />
    ...
    <body>
        ...
        <spring:url value="vendors/bower_components/jquery/dist/jquery.min.js" var="jquery"/>
        <spring:url value="vendors/bower_components/bootstrap/dist/js/bootstrap.min.js" var="bootstrap"/>

        <spring:url value="vendors/bower_components/flot/jquery.flot.js" var="flot"/>
        <spring:url value="vendors/bower_components/flot/jquery.flot.resize.js" var="flot.resize"/>
        <spring:url value="vendors/bower_components/flot.curvedlines/curvedLines.js" var="curvedLines"/>
        <spring:url value="vendors/sparklines/jquery.sparkline.min.js" var="sparkline"/>
        <spring:url value="vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js" var="easypiechart"/>

        <spring:url value="vendors/bower_components/moment/min/moment.min.js" var="moment"/>
        <spring:url value="vendors/bower_components/fullcalendar/dist/fullcalendar.min.js"  var="full_calendar"/>
        <spring:url value="vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js" var="simpleweather"/>
        <spring:url value="vendors/bower_components/Waves/dist/waves.min.js" var="waves"/>
        <spring:url value="vendors/bootstrap-growl/bootstrap-growl.min.js" var="growl"/>
        <spring:url value="vendors/bower_components/sweetalert2/dist/sweetalert2.min.js" var="sweetalert2"/>
        <spring:url value="vendors/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js" var="customScroolBar"/>
        <spring:url value="js/app.min.js" var="app"/>
        
         <script src="${jquery}"></script>
         <script src="${bootstrap}"></script>
         <script src="${flot}"></script>
         <script src="${flot.resize}"></script>
