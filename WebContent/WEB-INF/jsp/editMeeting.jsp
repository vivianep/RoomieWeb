                             ...
                             <div class="form-group">
                                ...
                                <div style="margin-top: 2%;">
                                    ...
                                    <select class="chosen" name="usersId" multiple data-placeholder="Choose meeting participants...">
                                     	...
                                     	<c:choose>
                                     		<c:when test="${usersId.contains(user.userId)}">
                                     			<option value="${user.userId}" class ="result-selected">${user.email}</option>
                                        		</c:when>
                                        		<c:otherwise>
                                    ...
                                    <div style="margin-top: 2%;">
                                        ...
                                        <select class="selectpicker" name="roomId">
                                            	...
                                            	<c:choose>
                                            		<c:when test="${meeting.room.roomId == room.roomId}">
                                ...
                                <div style="margin-top: 2%;">
                                   ...
                                   <div style="float:left;width:25%"">
                                        ...
                                        <div class="input-group form-group">
                                            ...
                                            <div class="dtp-container">
                                                <input type='text' name="startDate" value="${startDate}" class="form-control date-picker"
                                   ...
                                   <div class="col-sm-3">
                                            ...
                                            <div class="input-group form-group">
                                                ...
                                                <div class="dtp-container">
                                                    <input type='text' value="${startHour}" class="form-control time-picker" name="startTime"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="input-group form-group">
                                            <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                            <div class="dtp-container">
                                                <input type='text' value="${endDate}" class="form-control date-picker" name="endDate" 
                                                       placeholder="Click here...">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">    
                                            ...
                                            <div class="input-group form-group">
                                                <span class="input-group-addon"><i class="zmdi zmdi-time"></i></span>
                                                <div class="dtp-container">
                                                    <input type='text' value="${endHour}" class="form-control time-picker" id="datetimepicker5" name="endTime" 
                                                           placeholder="Click here...">
                                                </div>
                                            </div>
                                        </div> 
